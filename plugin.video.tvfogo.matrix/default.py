...
##CONFIGURAÇÕES
####  TITULO DO MENU  #################################################################
title_menu = '[B][COLOR chocolate]Glorioso Tv[/COLOR][/B]'
###  DESCRIÇÃO DO ADDON ###############################################################
title_descricao = 'TV AO VIVO [COLOR yellow]l[/COLOR] IPTV [COLOR yellow]l[/COLOR]'
...
url_origem = 'http://htmlescola.x10.mx/htmlsre/mgtf'
try:
